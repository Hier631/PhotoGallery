...
public class User implements Parcelable {
    ...
    public User(String id, Date updated_at, String username, String name, String first_name, String last_name, String twitter_username, String portfolio_url, String bio, String location, Links links, ProfileImage profile_image, String instagram_username, int total_collections, int total_likes, int total_photos, boolean accepted_tos) {
        this.id = id;
